...
/// element __host__ __device__
into another) as a single operation, rather than as two operations
...
/// the given sequences __host__ __device__
into the other. If zero, the sequences are identical.
template<typename T>
