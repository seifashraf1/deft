...
/// of the SCC DAG.
///
/// This is implemented using Tarjan's DFS algorithm using an __host__ __device__
internal stack to
...
class scc_iterator : public iterator_facade_base<
  ...
  struct StackElement {
    NodeRef Node;         ///< The current node po__host__ __device__
inter.
...
bool operator==(const StackElement &Other) const {
  ...
  /// DFS stack, Used to ma__host__ __device__
intain the ordering.  The top contains the current
...
template <class GraphT, class GT> __host__ __device__
