...
//
// GraphTraits can be used to create a view over a graph __host__ __device__
interpreting it
...
struct GraphTraits {
  ...
  //    Return iterators that po__host__ __device__
int to the beginning and ending of the child
  ...
  //     Return iterators that po__host__ __device__
int to the beginning and ending of the
