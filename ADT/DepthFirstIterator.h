...
bool External>   // Non-external set
...
// node have been processed. It is __host__ __device__
intended to distinguish of back and
...
bool> insert(NodeRef N) { return BaseSet::insert(N); }
...
inter.  This allows BBIt->getTerminator() f.e.
  ...
  df_iterator operator++(__host__ __device__
int) { // Postincrement
