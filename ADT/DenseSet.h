...
inter = const value_type *;
    ...
    ConstIterator operator++(__host__ __device__
int) { auto T = *this; ++I; return T; }
    __host__ __device__
bool operator==(const ConstIterator& X) const { return I == X.I; }
    __host__ __device__
...
bool> insert(ValueT &&V) {
  ...
  std::pair<iterator, __host__ __device__
bool> insert_as(const ValueT &V,
                                      const LookupKeyT &LookupKey) {
    return TheMap.insert_as({V, detail::DenseSetEmpty()}, LookupKey);
  }
  template <typename LookupKeyT>
  std::pair<iterator, __host__ __device__
bool> insert_as(ValueT &&V, const LookupKeyT &LookupKey) {
