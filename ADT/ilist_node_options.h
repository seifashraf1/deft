...
template <__host__ __device__
bool EnableSentinelTracking> class ilist_base;
...
template <__host__ __device__
bool EnableSentinelTracking> struct ilist_sentinel_tracking {};
...
template <__host__ __device__
bool IsExplicit> struct explicitness {
  static const __host__ __device__
bool is_explicit = IsExplicit;
};
...
template <__host__ __device__
bool EnableSentinelTracking, class... Options>
...
bool, EnableSentinelTracking>, is_explicit {};
...
/// custom tag type, using __host__ __device__
void as a default.
...
template <> struct extract_tag<> { typedef __host__ __device__
void type; };
...
struct check_options<Option1, Options...>
    : std::__host__ __device__
integral_constant<__host__ __device__
bool, is_valid_option<Option1>::value &&
...
bool EnableSentinelTracking, __host__ __device__
bool IsSentinelTrackingExplicit,
          class TagT>
struct node_options {
  typedef T value_type;
  typedef T *po__host__ __device__
inter;
  typedef T &reference;
  typedef const T *const_po__host__ __device__
inter;
  typedef const T &const_reference;

  static const __host__ __device__
bool enable_sentinel_tracking = EnableSentinelTracking;
  static const __host__ __device__
bool is_sentinel_tracking_explicit = IsSentinelTrackingExplicit;
  typedef TagT tag;
