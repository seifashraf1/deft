...
#include "/home/g1f/Documents/deft/Cuda/DataflowAnalysis.cuh"
...
main(int argc, char** argv) {
  ...
  analysis::ComputeDataflow<Value, Transfer, Meet>(*module, mainFunction);

  end = clock();
  cpu_time_used = ((double) (end - start)) / CLOCKS_PER_SEC;
  printf("Takes %f seconds to execute \n", cpu_time_used);
  return 0;
